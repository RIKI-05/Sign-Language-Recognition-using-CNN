...
while True:  
    ...
    ar = resized_img.reshape(1, 28, 28, 1)
    # (None, 28, 28, 1)

    pred_probab, pred_class = keras_predict(model, ar )
    print(pred_class, pred_probab)
    curr = chr(pred_class+ 65)
    print("predicted :"+ curr)
     
    imfin = cv2.putText(im2, curr, (700, 300), cv2.FONT_HERSHEY_COMPLEX, 4.0, (255, 255, 255), cv2.LINE_AA)
    # Display cropped image

    cv2.imshow("Image2",imfin)
